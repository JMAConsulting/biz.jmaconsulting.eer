...
SELECT @ufGId := id FROM civicrm_uf_group WHERE name = 'event_registration';

INSERT IGNORE INTO `civicrm_uf_group` ( `id`, `is_active`, `group_type`, `title`, `help_pre`, `help_post`, `limit_listings_group_id`, `post_URL`, `add_to_group_id`, `add_captcha`, `is_map`, `is_edit_link`, `is_uf_link`, `is_update_dupe`, `cancel_URL`, `is_cms_user`, `notify`, `is_reserved`, `name`, `created_id`, `created_date`, `is_proximity_search`) VALUES( @ufGId, 1, 'Contact', 'Your Registration Info', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, 0, NULL, NULL, 'event_registration', NULL, NULL, 0);
...
INSERT IGNORE INTO `civicrm_uf_field` ( `id`, `uf_group_id`, `field_name`, `is_active`, `is_view`, `is_required`, `weight`, `help_post`, `help_pre`, `visibility`, `in_selector`, `is_searchable`, `location_type_id`, `phone_type_id`, `label`, `field_type`, `is_reserved`) VALUES
( @ufFId, @ufGId, 'email', 1, 0, 1, 1, '', '', 'User and User Admin Only', 0, 0, NULL, NULL, 'Email Address', 'Contact', NULL);
...
INSERT IGNORE INTO `civicrm_uf_group` ( `id`, `is_active`, `group_type`, `title`, `help_pre`, `help_post`, `limit_listings_group_id`, `post_URL`, `add_to_group_id`, `add_captcha`, `is_map`, `is_edit_link`, `is_uf_link`, `is_update_dupe`, `cancel_URL`, `is_cms_user`, `notify`, `is_reserved`, `name`, `created_id`, `created_date`, `is_proximity_search`) VALUES ( @ufGId, 1, 'Individual,Contact', 'Current User Profile', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, 0, NULL, NULL, 'biz_jmaconsulting_eer_current_user_profile', NULL, NULL, 0);
...
INSERT IGNORE INTO `civicrm_uf_group` ( `id`,`is_active`, `group_type`, `title`, `help_pre`, `help_post`, `limit_listings_group_id`, `post_URL`, `add_to_group_id`, `add_captcha`, `is_map`, `is_edit_link`, `is_uf_link`, `is_update_dupe`, `cancel_URL`, `is_cms_user`, `notify`, `is_reserved`, `name`, `created_id`, `created_date`, `is_proximity_search`) VALUES ( @ufGId, 1, 'Individual,Contact', 'Other Parent Or Guardian', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, 0, NULL, NULL, 'biz_jmaconsulting_eer_other_parent_or_guardian', NULL, NULL, 0);
...
INSERT IGNORE INTO `civicrm_uf_group` ( `id`, `is_active`, `group_type`, `title`, `help_pre`, `help_post`, `limit_listings_group_id`, `post_URL`, `add_to_group_id`, `add_captcha`, `is_map`, `is_edit_link`, `is_uf_link`, `is_update_dupe`, `cancel_URL`, `is_cms_user`, `notify`, `is_reserved`, `name`, `created_id`, `created_date`, `is_proximity_search`) VALUES ( @ufGId, 1, 'Individual,Contact', 'First Emergency Contacts', NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, 0, NULL, NULL, 'biz_jmaconsulting_eer_first_emergency_contacts', NULL, NULL, 0);
